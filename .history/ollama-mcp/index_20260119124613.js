...
(async () => {
  ...
  console.log("Ollama response:", tools);
  console.log("Ollama response:", message);
  console.log("Ollama response:", message.tool_calls);
  console.log("Ollama response:", message.data);
  ...
  if (message.tool_calls?.length) {
    ...
    console.log("LLM response:", message.content ?? "(no text response)");
    }
